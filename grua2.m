...
yprima(2)= (190000 - 1.5*(y(2))^2*(y(5)+Lb) + ((y(4))^2)*sin(y(1))*cos(y(1))*(((1/3)*Mb*Lb^2) + ((1/12)*Mf*(y(5))^2) + (Mf*((y(5)/2)+Lb)^2) + (M*(y(5)+Lb)^2)) + g*sin(y(1))*((Mb*(Lb/2))+ Mf*((y(5)/2)+Lb)+M*(y(5)+Lb))-y(2)*   (((1/6)*Mf*y(5)*y(6)) + (2*Mf*((y(5)/2)+Lb)*(y(6)/2))+(2*M*(y(5)+Lb)*y(6))))         /   (((1/3)*Mb*Lb^2)+((1/12)*Mf*(y(5)^2))+(Mf*((y(5)/2)+Lb)^2)+M*(y(5)+Lb)^2)                                            ;
yprima(3)=y(4);
